...
class ContactDAO(object):
    ...
    def getAllContacts(self):
        res = self.__db.fetch("SELECT id,haravan_id,haravan_data,bitrix24_id,bitrix_status,update_ts,haravan_status FROM tbl_contact_customer ORDER BY id DESC", None)
    ...
    def getAllContactsPages(self, __from, __to):
        res = self.__db.fetch("SELECT id,haravan_id,haravan_data,bitrix24_id,bitrix_status,update_ts,haravan_status FROM tbl_contact_customer LIMIT %s,%s ORDER BY id DESC", (__from, __to))
    ...
    def insertContactRecord(self, hanravan_id, bitrix24_id):
        ...
        res = self.__db.execute(sql, (hanravan_id, bitrix24_id))
    ...
    def get_contacts(self):
        res = self.__db.fetch("SELECT * FROM tbl_contact_customer", None)
